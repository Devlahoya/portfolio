      ...
      <div className="text-center mt-8">
        ...
        >
          ...
          { error &&  <Error><p>All Fields Are Required</p></Error>}
            <p className="md:text-base text-sm  text-white break-words text-left">Name</p>
            <input className='rounded-sm p-2' id="name "type="text" name="from_name" placeholder="Your Name" value={name}
            onChange={ (e) => setName(e.target.value) }/>            
            <p className="md:text-base text-sm  text-white break-words text-left">Email</p>
            <input className='rounded-sm p-2' id="email" type="email" name="user_email" placeholder="Your Email Address" value={email}
            onChange={ (e) => setEmail(e.target.value) }/>            
            <p className="md:text-base text-sm  text-white break-words text-left">Message</p>
            <textarea className='rounded-sm p-2' id="message" name="message" placeholder="Your Message" rows={10} value={message}
            onChange={ (e) => setMessage(e.target.value) }></textarea>
            <ButtonContainer>
              <ThemeProvider theme={Dark}>
            <Button type="submit" text="Send Message"></Button>
            </ThemeProvider>
            </ButtonContainer>
          </form>
